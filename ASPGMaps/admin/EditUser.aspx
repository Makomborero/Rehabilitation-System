<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="EditUser.aspx.cs" Inherits="ASPGMaps.admin.EditUser" %>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                              <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control form-control-user" placeholder="Force Number" />
                                        </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                               <asp:Button Text="Back" ID="button1" CssClass="btn btn-primary btn-user btn-block" runat="server" OnClick="button1_Click"/>
                                            </div>
                                        </div>
                                    </div>
                        </div>
