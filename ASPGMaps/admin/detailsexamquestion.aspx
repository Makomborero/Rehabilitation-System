    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                <asp:Button ID="btn_detailsexamquestion" runat="server" Text="Details Assessment Question" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
            </div>
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="table table-responsive">
                        <asp:DetailsView ID="gridview_examdetails" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateRows="False">
                            <Fields>
                                <asp:BoundField DataField="exam_description" HeaderText="Assessment Discription" NullDisplayText="No Discription">
