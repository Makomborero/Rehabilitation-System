<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="True" Inherits="ITS.MyProfile" CodeFile="MyProfile.aspx.cs" %>
                            ...
                            <div class="user">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <h4 class="form-control-user" style="display: block;width: 100%;height: calc(1.5em + 0.75rem + 2px);padding: 0.375rem 0.75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #6e707e;background-color: #fff;background-clip: padding-box;border-radius: 0.35rem;transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;">Identification</h4>
                                            </div>
                                            <div class="col-sm-6">
                                              <asp:TextBox runat="server" ID="TextBox1" CssClass="form-control form-control-user" placeholder="Identification" />
                                        </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <h4 class="form-control-user" style="display: block;width: 100%;height: calc(1.5em + 0.75rem + 2px);padding: 0.375rem 0.75rem;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #6e707e;background-color: #fff;background-clip: padding-box;border-radius: 0.35rem;transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;">Drug Category</h4>
                                            </div>
                                            <div class="col-sm-6">
                                        <asp:DropdownList runat="server" ID="DropdownList2" CssClass="form-control form-control-user" placeholder="Drug Category">
