    ...
    <div class=" col-md-12">
        <div class="card">
            ...
            <div class="btn-group bg-danger">
                <asp:Button ID="btn_paneleditexam" runat="server" Text="Edit Assessment" CssClass="btn btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
            </div>
            <%-- Edit exam --%>
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Assessment Name</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txt_editexamname" runat="server" CssClass="form-control"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="require_editexamname" runat="server" ErrorMessage="Enter Assessment name" ControlToValidate="txt_editexamname" ForeColor="red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Assessment Discription</label>
                    <div class="col-md-9">
                        <asp:TextBox ID="txt_editexamdis" runat="server" TextMode="MultiLine" CssClass="form-control" Height="150px"></asp:TextBox>
                    </div>
                </div>
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Assessment Date</label>
                    <div class="col-md-4">
                        <asp:TextBox ID="txt_editexamdate" runat="server" CssClass="form-control" TextMode="Date"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="require_editexamdate" runat="server" ErrorMessage="Enter Assessment date" ControlToValidate="txt_editexamdate" ForeColor="red" Display="Dynamic"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Assessment Pass Marks</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Assessment Total Marks</label>
                    <div class="col-md-4">
