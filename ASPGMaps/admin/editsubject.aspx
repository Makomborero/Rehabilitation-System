        ...
        <div class="card">
         <%--Button For edit subject slect--%>
            ...
            <div class="card-body">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Topic Name</label>
                        <div class="col-md-4">
                            <asp:TextBox ID="txt_subjectedit" runat="server" CssClass="form-control"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="require_subject" runat="server" ErrorMessage="Enter topic" ControlToValidate="txt_subjectedit" ForeColor="red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_editsubject" runat="server" Text="Edit topic" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" OnClick="btn_editsubject_Click" />
                        </div>
