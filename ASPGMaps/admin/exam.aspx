                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <asp:RequiredFieldValidator ID="require_examname" runat="server" ErrorMessage="Enter Assessment name" ControlToValidate="txt_examname" ForeColor="red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Assessment Description</label>
                        <div class="col-md-9">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Assessment Duration (Minutes)</label>
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        <label class="col-md-2 col-form-label ">Assessment Pass Mark</label>
                        <div class="col-md-4">
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="grdview_examlist" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" OnRowCommand="grdview_examlist_RowCommand" AllowPaging="True" OnPageIndexChanging="grdview_examlist_PageIndexChanging" PageSize="5">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="exam_name" HeaderText="Topic Name" />
                                    <asp:BoundField DataField="exam_date" HeaderText="Assessment Date" DataFormatString="{0:d}" />
