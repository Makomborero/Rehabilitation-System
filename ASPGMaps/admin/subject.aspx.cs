...
public partial class admin_subject : System.Web.UI.Page
{
    ...
    protected void btn_addsubject_Click(object sender, EventArgs e)
    {
        if (IsValid)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("insert into subject (subject_name, category_fid, category_name) values (@subject_name,@category_fid,@category_name)", con);
                ...
                cmd.Parameters.AddWithValue("@category_name", drp_category.SelectedItem.Text);
                try
                {
                    con.Open();
    ...
    public void get_categorydrp()
    {
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                ListItem li = new ListItem("Select category", "2");
